...
Before working with Lotus 1-2-3 in Olivetti computer, executing ms-dos commands, Amstrad CPC end user, copying ZX Basic code from pc Magazine, telex user and Telematch console Pong player.
